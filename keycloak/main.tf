...
resource "helm_release" "keycloak" {
  ...
  values = [
    ...
    # Update the following section if you have a prometheus operator installed and want to enable metrics
    # Use the correct namespace where your prometheus operator is installed
    metrics:
      enabled: false
      serviceMonitor:
        enabled: false
